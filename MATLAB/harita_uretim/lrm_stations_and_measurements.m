...
%Veriler
gunluk_data = readtable("/home/furkan/deus/ALTIMETRY/processler/tum_gunluk_lrm_verileri.xlsx");
aylik_data = readtable("/home/furkan/deus/ALTIMETRY/processler/tum_aylik_lrm_verileri.xlsx");
...
geoscatter(aylik_data.glat_00, aylik_data.glon_00, "filled", "o", "MarkerEdgeColor", "c", ...
           "MarkerFaceColor","c", "DisplayName", "Aylık LRM/SAR Verisi");
geobasemap satellite;

title("Aylık Ortalama LRM/SAR Verileri ile TUDES İstasyonlarının Koordinatları");
legend();
