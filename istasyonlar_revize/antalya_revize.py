...
enlem = 36.71775099999999
boylam = 30.741204999999997
...
#Excel tabloları
#lrm_aylik_veriler_excel = rmn.df2excel(idw_lrm, "ALES", "ANTALYA", "antalya_lrm_idw")
#sar_aylik_veriler_excel = rmn.df2excel(idw_sar, "ALES", "ANTALYA", "antalya_sar_idw")

#Verilerin çizdirilmesi
#aylik_ssh_plot = pr.plot_ssh_aylik(idw_lrm, idw_sar, "Antalya Aylık Ağırlıklandırılmış Altimetre Verileri")
#-----------------------------------------------------------------------------------------------------------------------
#ANTALYA GELENEKSEL VERİLER
#Verinin okunması
gel_envisat = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ANTALYA/ANTALYA_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
#gel_gfo = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ANTALYA/ANTALYA_VERİLER/GFO/GFO_DATA/*.nc")
gel_cryosat2 = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ANTALYA/ANTALYA_VERİLER/CRYOSAT2/CRYOSAT2_DATA/*.nc")
#gel_s3a = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ANTALYA/ANTALYA_VERİLER/SENTINEL3A/SENTINEL3A_DATA/*.nc")
gel_s3b = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ANTALYA/ANTALYA_VERİLER/SENTINEL3B/SENTINEL3B_DATA/*.nc")

#Verilerin değerlerinin alınması
gel_envisat = rmn.bir_index(gel_envisat)
#gel_gfo = rmn.bir_index(gel_gfo)
gel_cryosat2 = rmn.sifir_index(gel_cryosat2)
#gel_s3a = rmn.sifir_index(gel_s3a)
gel_s3b = rmn.sifir_index(gel_s3b)

#Verilerin birleştirilmesi
#Tüm veriler
gel_frames = [gel_envisat, gel_cryosat2, gel_s3b]
...
#Ortalama koordinat değerinin hesabı
gel_hesaba_girecek_veriler = [gel_s3b]
...
#Ağırlık hesabı ile verilerin yeniden düzenlenmesi
gel_lrm_agirliklar = rmn.agirlik_hesabi(gel_lrm_veriler_gunluk, gel_enlem, gel_boylam)
gel_sar_agirliklar = rmn.agirlik_hesabi(gel_sar_veriler_gunluk, gel_enlem, gel_boylam)
...
#Excel tabloları
#gel_lrm_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_lrm, "SSH_VERİLERİ", "ANTALYA", "antalya_lrm_idw")
#gel_sar_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_sar, "SSH_VERİLERİ", "ANTALYA", "antalya_sar_idw")

#Verilerin çizdirilmesi
#gel_aylik_ssh_plot = pr.plot_ssh_aylikv2(gel_idw_lrm, gel_idw_sar, "Antalya Aylık Ağırlıklandırılmış Altimetre Verileri")

#KARŞILAŞTIRMA PLOTUNUN ÇİZDİRİLMESİ

#karsilastirma = pr.iki_df_ssh_plot(idw_lrm, idw_sar, gel_idw_lrm, gel_idw_sar, "Antalya Aylık Ağırlıklandırılmış ALES ve Altimetri Verileri")