...
#ARSUZ ALES
#Verinin okunması
ales_envisat = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/ARSUZ/ARSUZ_VERİLER_YENİ/ENVISAT/ENVISAT_DATA/*.nc")
ales_jason1em = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/ARSUZ/ARSUZ_VERİLER_YENİ/JASON1_EM/JASON1_EM_DATA/*.nc")
ales_saral = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/ARSUZ/ARSUZ_VERİLER_YENİ/SARAL/SARAL_DATA/*.nc")
...
ales_s3b = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/ARSUZ/ARSUZ_VERİLER_YENİ/SENTINEL3B/SENTINEL3B_DATA/*.nc")
ales_s3a = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/ARSUZ/ARSUZ_VERİLER_YENİ/SENTINEL3A/SENTINEL3A_DATA/*.nc")
...
ales_saraldp = rmn.dort_index(ales_saraldp)
...
ales_jason1gm = rmn.filter_ales_05(ales_jason1gm)
...
#LRM verileri
lrm_frames = [ales_envisat, ales_jason1em, ales_jason1gm, ales_saral, ales_saraldp]
...
hesaba_girecek_veriler = [ales_envisat]
ort_koordinatlar = rmn.ort_koord(hesaba_girecek_veriler, 6)
...
#Bazı uzaktaki verileri elimine etmek için şöyle bir filtre uyguluyorum
idw_lrm = idw_lrm[idw_lrm["glon.00"] > 35.5713]
idw_sar = idw_sar[idw_sar["glon.00"] > 35.5713]
idw_lrm = idw_lrm[idw_lrm["glat.00"] < 36.5983]
idw_sar = idw_sar[idw_sar["glat.00"] < 36.5983]
...
#Excel tabloları
#lrm_aylik_veriler_excel = rmn.df2excel(idw_lrm, "ALES", "ARSUZ", "arsuz_lrm_idw")
#sar_aylik_veriler_excel = rmn.df2excel(idw_sar, "ALES", "ARSUZ", "arsuz_sar_idw")

#Verilerin çizdirilmesi
#aylik_ssh_plot = pr.plot_ssh_aylik(idw_lrm, idw_sar, "Arsuz Aylık Ağırlıklandırılmış Altimetre Verileri")

#-----------------------------------------------------------------------------------------------------------------------
#ARSUZ GELENEKSEL VERİLER
#Verinin okunması
gel_envisat = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ARSUZ/ARSUZ_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
gel_gfo = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ARSUZ/ARSUZ_VERİLER/GFO/GFO_DATA/*.nc")
gel_cryosat2 = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ARSUZ/ARSUZ_VERİLER/CRYOSAT2/CRYOSAT2_DATA/*.nc")
gel_s3a = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ARSUZ/ARSUZ_VERİLER/SENTINEL3A/SENTINEL3A_DATA/*.nc")

#Verilerin değerlerinin alınması
gel_envisat = rmn.sifir_index(gel_envisat)
gel_gfo = rmn.sifir_index(gel_gfo)
gel_cryosat2 = rmn.sifir_index(gel_cryosat2)
gel_s3a = rmn.sifir_index(gel_s3a)

#Verilerin birleştirilmesi
#Tüm veriler
gel_frames = [gel_envisat, gel_gfo, gel_cryosat2, gel_s3a]
gel_veriler = rmn.merge_df(gel_frames)

#LRM verileri
gel_lrm_frames = [gel_envisat, gel_gfo, gel_cryosat2]
...
#Ortalama koordinat değerinin hesabı
gel_hesaba_girecek_veriler = [gel_gfo]
...
#Excel tabloları
#gel_lrm_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_lrm, "SSH_VERİLERİ", "ARSUZ", "arsuz_lrm_idw")
#gel_sar_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_sar, "SSH_VERİLERİ", "ARSUZ", "arsuz_sar_idw")

#Verilerin çizdirilmesi
#gel_aylik_ssh_plot = pr.plot_ssh_aylikv2(gel_idw_lrm, gel_idw_sar, "Arsuz Aylık Ağırlıklandırılmış Altimetre Verileri")

#KARŞILAŞTIRMA
#karsilastirma = pr.iki_df_ssh_plot(idw_lrm, idw_sar, gel_idw_lrm, gel_idw_sar, "Arsuz Aylık Ağırlıklandırılmış ALES ve Altimetri Verileri")
