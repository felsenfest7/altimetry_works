...
#ERDEMLİ ALES
#Verinin okunması
ales_envisat = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/ERDEMLİ/ERDEMLİ_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
...
hesaba_girecek_veriler = [ales_envisat, ales_jason1, ales_jason2, ales_jason3]
...
#Excel tabloları
#lrm_aylik_veriler_excel = rmn.df2excel(idw_lrm, "ALES", "ERDEMLİ", "erdemli_lrm_idw")
#sar_aylik_veriler_excel = rmn.df2excel(idw_sar, "ALES", "ERDEMLİ", "erdemli_sar_idw")

#Verilerin çizdirilmesi
#aylik_ssh_plot = pr.plot_ssh_aylik(idw_lrm, idw_sar, "Erdemli Aylık Ağırlıklandırılmış Altimetre Verileri")
#-----------------------------------------------------------------------------------------------------------------------
#ERDEMLİ GELENEKSEL VERİLER
#Verinin okunması
gel_envisat_427 = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ERDEMLİ/ERDEMLİ_VERİLER/ENVISAT/ENVISAT_427_DATA/*.nc")
gel_envisat_500 = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ERDEMLİ/ERDEMLİ_VERİLER/ENVISAT/ENVISAT_500_DATA/*.nc")
gel_cryosat2 = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ERDEMLİ/ERDEMLİ_VERİLER/CRYOSAT2/CRYOSAT2_DATA/*.nc")
gel_s3a = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/ERDEMLİ/ERDEMLİ_VERİLER/SENTINEL3A/SENTINEL3A_DATA/*.nc")

#Verilerin değerlerinin alınması
gel_envisat_427 = rmn.sifir_index(gel_envisat_427)
gel_envisat_500 = rmn.sifir_index(gel_envisat_500)
gel_cryosat2 = rmn.sifir_index(gel_cryosat2)
gel_s3a = rmn.sifir_index(gel_s3a)

#Verilerin birleştirilmesi
#Tüm veriler
gel_frames = [gel_envisat_427, gel_envisat_500, gel_cryosat2, gel_s3a]
gel_veriler = rmn.merge_df(gel_frames)

#LRM verileri
gel_lrm_frames = [gel_envisat_427, gel_envisat_500, gel_cryosat2]
...
#Bir tane noise var elle düzeltmeye karar verdim (38 metre gösteriyor SSH'ı)
gel_idw_lrm = gel_idw_lrm[gel_idw_lrm["ssh_idw"] < 32]
gel_idw_lrm = gel_idw_lrm[gel_idw_lrm["ssh_idw"] > 24]

#Excel tabloları
#gel_lrm_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_lrm, "SSH_VERİLERİ", "ERDEMLİ", "erdemli_lrm_idw")
#gel_sar_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_sar, "SSH_VERİLERİ", "ERDEMLİ", "erdemli_sar_idw")

#Verilerin çizdirilmesi
#gel_aylik_ssh_plot = pr.plot_ssh_aylikv2(gel_idw_lrm, gel_idw_sar, "Erdemli Aylık Ağırlıklandırılmış Altimetre Verileri")

#KARŞILAŞTIRMA
#karsilastirma = pr.iki_df_ssh_plot(idw_lrm, idw_sar, gel_idw_lrm, gel_idw_sar, "Erdemli Aylık Ağırlıklandırılmış ALES ve Altimetri Verileri")
