...
# İĞNEADA ALES
#Verinin okunması
ales_envisat = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/IGNEADA/IGNEADA_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
...
ales_s3a = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/IGNEADA/IGNEADA_VERİLER/SENTINEL3A/SENTINEL3A_DATA/*.nc")
...
#Tüm veriler
ales_frames = [ales_envisat, ales_jason1, ales_jason2, ales_jason3, ales_s3a]
ales_veriler = rmn.merge_df(ales_frames)

#LRM verileri
lrm_frames = [ales_envisat, ales_jason1, ales_jason2, ales_jason3]
...
lrm_veriler_gunluk = lrm_veriler_gunluk[lrm_veriler_gunluk["ssh.55"] < 38.5]
lrm_veriler_gunluk = lrm_veriler_gunluk[lrm_veriler_gunluk["ssh.55"] > 37.25]
...
ort_koordinatlar = rmn.ort_koord(hesaba_girecek_veriler, 10)

enlem = ort_koordinatlar[0]
boylam = ort_koordinatlar[1]
enlem = 41.9008320625
boylam =  28.202867343749997
...
#Excel tabloları
#lrm_aylik_veriler_excel = rmn.df2excel(idw_lrm, "ALES", "IGNEADA", "igneada_lrm_idw")
#sar_aylik_veriler_excel = rmn.df2excel(idw_sar, "ALES", "IGNEADA", "igneada_sar_idw")

#Verilerin çizdirilmesi
#aylik_ssh_plot = pr.plot_ssh_aylik(idw_lrm, idw_sar, "İğneada Aylık Ağırlıklandırılmış Altimetre Verileri")
#-----------------------------------------------------------------------------------------------------------------------
#İĞNEADA GELENEKSEL VERİLER
#Verinin okunması
gel_envisat = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/IGNEADA/IGNEADA_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
gel_gfo = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/IGNEADA/IGNEADA_VERİLER/GFO/GFO_DATA/*.nc")
gel_cryosat2 = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/IGNEADA/IGNEADA_VERİLER/CRYOSAT2/CRYOSAT2_DATA/*.nc")
gel_s3a = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/IGNEADA/IGNEADA_VERİLER/SENTINEL3A/SENTINEL3A_DATA/*.nc")
...
#Excel tabloları
#gel_lrm_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_lrm, "SSH_VERİLERİ", "IGNEADA", "igneada_lrm_idw")
#gel_sar_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_sar, "SSH_VERİLERİ", "IGNEADA", "igneada_sar_idw")

#Verilerin çizdirilmesi
#gel_aylik_ssh_plot = pr.plot_ssh_aylikv2(gel_idw_lrm, gel_idw_sar, "İğneada Aylık Ağırlıklandırılmış Altimetre Verileri")

#KARŞILAŞTIRMA
#karsilastirma = pr.iki_df_ssh_plot(idw_lrm, idw_sar, gel_idw_lrm, gel_idw_sar, "İğneada Aylık Ağırlıklandırılmış ALES ve Altimetri Verileri")
