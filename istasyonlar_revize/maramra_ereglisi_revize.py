...
les_veriler_aylik = ales_veriler_aylik.dropna(1)
...
#Excel tabloları
#lrm_aylik_veriler_excel = rmn.df2excel(idw_lrm, "ALES", "MARMARA_EREGLISI", "marmara_ereglisi_lrm_idw")
#sar_aylik_veriler_excel = rmn.df2excel(idw_sar, "ALES", "MARMARA_EREGLISI", "marmara_ereglisi_sar_idw")

#Verilerin çizdirilmesi
#aylik_ssh_plot = pr.plot_ssh_aylik(idw_lrm, idw_sar, "Marmara Ereğlisi Aylık Ağırlıklandırılmış Altimetre Verileri")

#-----------------------------------------------------------------------------------------------------------------------
#MARMARA EREĞLİSİ GELENEKSEL VERİLER
#Verinin okunması
gel_cryosat2 = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/MARMARA_EREGLISI/MARMARA_EREGLISI_VERİLER/CRYOSAT2/CRYOSAT2_DATA/*.nc")
gel_s3a = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/MARMARA_EREGLISI/MARMARA_EREGLISI_VERİLER/SENTINEL3A/SENTINEL3A_DATA/*.nc")
...
#Excel tabloları
#gel_lrm_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_lrm, "SSH_VERİLERİ", "MARMARA_EREGLISI", "merg_lrm_idw")
#gel_sar_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_sar, "SSH_VERİLERİ", "MARMARA_EREGLISI", "merg_sar_idw")

#Verilerin çizdirilmesi
#gel_aylik_ssh_plot = pr.plot_ssh_aylikv2(gel_idw_lrm, gel_idw_sar, "Marmara Ereğlisi Aylık Ağırlıklandırılmış Altimetre Verileri")

#KARŞILAŞTIRMA
#karsilastirma = pr.iki_df_ssh_plot(idw_lrm, idw_sar, gel_idw_lrm, gel_idw_sar, "Marmara Ereğlisi Aylık Ağırlıklandırılmış ALES ve Altimetri Verileri")
