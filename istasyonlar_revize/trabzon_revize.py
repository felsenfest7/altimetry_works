...
hesaba_girecek_veriler = [ales_jason1, ales_jason2, ales_jason3, ales_s3a]
...
#Excel tabloları
#lrm_aylik_veriler_excel = rmn.df2excel(idw_lrm, "ALES", "TRABZON", "trabzon_lrm_idw")
#sar_aylik_veriler_excel = rmn.df2excel(idw_sar, "ALES", "TRABZON", "trabzon_sar_idw")

#Verilerin çizdirilmesi
#aylik_ssh_plot = pr.plot_ssh_aylik(idw_lrm, idw_sar, "Trabzon Aylık Ağırlıklandırılmış Altimetre Verileri")

#-----------------------------------------------------------------------------------------------------------------------
#TRABZON GELENEKSEL VERİLER
#Verinin okunması
gel_envisat = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/TRABZON/TRABZON_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
gel_cryosat2 = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/TRABZON/TRABZON_VERİLER/CRYOSAT2/CRYOSAT2_DATA/*.nc")
gel_s3a = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/TRABZON/TRABZON_VERİLER/SENTINEL3A/SENTINEL3A_DATA/*.nc")
gel_s3b = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/TRABZON/TRABZON_VERİLER/SENTINEL3B/SENTINEL3B_DATA/*.nc")
...
#Verilerin birleştirilmesi
#Tüm veriler
gel_frames = [gel_envisat, gel_cryosat2, gel_s3a, gel_s3b]
...
#SAR verileri
gel_sar_frames = [gel_s3a, gel_s3b]
...
#Excel tabloları
#gel_lrm_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_lrm, "SSH_VERİLERİ", "TRABZON", "trabzon_lrm_idw")
#gel_sar_aylik_veriler_excel = rmn.df2excel_ssh(gel_idw_sar, "SSH_VERİLERİ", "TRABZON", "trabzon_sar_idw")

#Verilerin çizdirilmesi
#gel_aylik_ssh_plot = pr.plot_ssh_aylikv2(gel_idw_lrm, gel_idw_sar, "Trabzon Aylık Ağırlıklandırılmış Altimetre Verileri")

#KARŞILAŞTIRMA
#karsilastirma = pr.iki_df_ssh_plot(idw_lrm, idw_sar, gel_idw_lrm, gel_idw_sar, "Trabzon Aylık Ağırlıklandırılmış ALES ve Altimetri Verileri")
